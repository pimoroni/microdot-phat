...
font = {
    ...
    196: [0x7e, 0x11, 0x11, 0x11, 0x7e],  # Ä, display A instead
    197: [0x7e, 0x11, 0x11, 0x11, 0x7e],  # Å, display A instead
    198: [0x7e, 0x11, 0x11, 0x11, 0x7e],  # Æ, display A instead
    199: [0x3e, 0x41, 0x41, 0x41, 0x22],  # Ç, display C instead
    200: [0x7f, 0x49, 0x49, 0x49, 0x41],  # È, display E instead
    201: [0x7f, 0x49, 0x49, 0x49, 0x41],  # É, display E instead
    202: [0x7f, 0x49, 0x49, 0x49, 0x41],  # Ê, display E instead
    203: [0x7f, 0x49, 0x49, 0x49, 0x41],  # Ë, display E instead
    214: [0x38, 0x45, 0x44, 0x45, 0x38],  # Ö, identical to lowercase ö due to size constraints
    216: [0x3E, 0x51, 0x49, 0x45, 0x3E],  # Ø
    228: [0x20, 0x54, 0x54, 0x54, 0x78],  # ä, display a instead
    229: [0x20, 0x54, 0x54, 0x54, 0x78],  # å, display a instead
    230: [0x20, 0x54, 0x54, 0x54, 0x78],  # æ, display a instead
    231: [0x3e, 0x41, 0x41, 0x41, 0x22],  # ç, display c instead
    232: [0x38, 0x54, 0x54, 0x54, 0x18],  # è, display e instead
    233: [0x38, 0x54, 0x54, 0x54, 0x18],  # é, display e instead
    234: [0x38, 0x54, 0x54, 0x54, 0x18],  # ê, display e instead
    235: [0x38, 0x54, 0x54, 0x54, 0x18],  # ë, display e instead
    246: [0x38, 0x45, 0x44, 0x45, 0x38],  # ö
    248: [0x3e, 0x64, 0x4c, 0x54, 0x3e],  # ø
